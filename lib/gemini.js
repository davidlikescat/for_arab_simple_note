...
genAI.apiVersion = "v1beta"; // Use v1beta API for broader model support
...
**구조 및 작성 지침**:
1.  **title**: 회의 내용을 대표하는 간결한 제목. 반드시 "{YYYYMMDD}_제목" 형식으로 작성하세요 (예: "20241127_4분기 마케팅 전략 기획 회의"). 날짜는 회의 발생 날짜이며, 제목은 회의 내용을 잘 요약할 수 있는 내용으로 작성하세요.
...
async function processMeetingNotes(text) {
  try {
    ...
    // Generic cleanup for markdown code blocks or raw text
